  ...
  return (
    <div className="min-h-screen relative w-full">
      ...
      <div className="xl:container w-full  md:pb-20 pb-10  relative z-20 mx-auto flex pt-32 flex-col items-center">
        ...
        <p className="lg:w-2/5 sm:w-1/2 xs:w-[66%] w-[76%] lg:text-base text-sm font-normal text-light lg:mt-5 mt-3 text-center">
        ...
        <div className="flex mt-12 flex-col items-center w-full">
          <h1 className="text-primary font-medium text-center lg:text-2xl md:text-xl text-base">
            How can we help you form
          </h1>
          <div className="flex sm:flex-row flex-col items-center w-full xl:px-16 md:px-10 sm:px-5 xs:px-12 px-6 mt-4 xl:gap-x-8 lg:gap-x-4 sm:gap-x-2 sm:gap-y-0 gap-y-2">
            {contactDetails?.map(
              (
      ...
      <div className="2xl:container w-full relative z-10 flex lg:mt-12 md:mt-8 sm:mt-6 mt-4  flex-col mx-auto items-center">
        <h1 className="xl:text-5xl lg:text-4xl text-3xl font-medium text-primary">
          Meet Us
        </h1>
