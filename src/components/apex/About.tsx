...
const About = () => {
  ...
  return (
    ...
    >
      <h1 className="text-6xl md:text-5xl sm:text-4xl text-black font-semibold md:relative md:left-8 sm:left-4 left-0">
        About us
      </h1>
      <p className="mt-3 font-normal text-black/40 lg:w-1/2 md:w-3/4 w-full md:relative md:left-6 sm:left-3 left-0">
      ...
      <div className="2xl:h-[630px] lg:h-[560px] w-full mt-6 flex flex-col gap-y-6">
        <div className="flex lg:flex-row flex-col lg:h-[265px] gap-6 items-center">
          <div className="lg:h-full h-[250px] group relative w-full bg-[#EFF5FF] flex justify-between items-start lg:px-14 md:px-10 px-6 py-10 rounded-[30px] overflow-hidden">
          ...
          <div className="lg:h-full h-[250px] w-full bg-primary group rounded-[30px] lg:px-14 md:px-10 px-6 py-10 flex flex-row justify-between relative overflow-hidden">
        ...
        <div className="w-full lg:h-[265px] md:h-[300px] h-auto py-10 bg-[#F3F3F3] group rounded-[30px] relative lg:px-14 md:px-10 px-6 flex flex-col md:flex-row items-start justify-between overflow-hidden">
